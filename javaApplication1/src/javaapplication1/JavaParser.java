...
public class JavaParser implements Comparator<JavaParser>, Serializable{
            ...
            int instance, int position1 )
    {
        ...
        if (this.docListStruct.isEmpty()) {
            docListStruct.add(new documentID1(newValue,1,position1));
        }
   ...
   */
   public void addDocListStruct(String new_ID, int position1 ){
      
      if (this.docListStruct.isEmpty()) {
            this.docListStruct.add(new documentID1(new_ID,1,position1));
        }
  ...
  */
   ...
   */
  public void updateDocListStruct(String new_ID, int position1){
      int count = 0; 
      if (! this.docListStruct.isEmpty()) {
