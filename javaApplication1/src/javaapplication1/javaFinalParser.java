...
public class javaFinalParser implements Comparator<javaFinalParser>, 
            ...
            int instance, int position )
    {
        ...
        if (this.docListStruct.isEmpty()) {
            docListStruct.add(new documentID1(newValue,1, position));
        }
  ...
  */
   ...
   * @param new_ID 
   */
   public void addDocListStruct(String new_ID, int position ){
      
      if (this.docListStruct.isEmpty()) {
            this.docListStruct.add(new documentID1(new_ID,1,position));
        }
   ...
   * @param new_ID 
   */
  public void updateDocListStruct(String new_ID, int position){
      int count = 0; 
      if (! this.docListStruct.isEmpty()) {
